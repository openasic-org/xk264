...
wire [INPUT_WIDTH+1:0] s0_w, s1_w, s2_w, s3_w;
...
assign n_s2_plus1 = ~s2_w + 1'b1;
assign n_s3_plus1 = ~s3_w + 1'b1;
assign n_t2_plus1 = ~t2 + 1'b1;
assign n_t3_plus1 = ~t3 + 1'b1;

assign t0 = s0_w + s2_w;
assign t1 = s0_w + n_s2_plus1;
assign t2 = s1_w + {s3_w[INPUT_WIDTH+1],s3_w[INPUT_WIDTH+1:1]};
assign t3 = {s1_w[INPUT_WIDTH+1],s1_w[INPUT_WIDTH+1:1]} + n_s3_plus1;
...
wire [INPUT_WIDTH+3:0] s0_w, s1_w, s2_w, s3_w;

wire [INPUT_WIDTH+3:0] t0, t1, t2, t3;
wire [INPUT_WIDTH+3:0] n_s2_plus1; 
wire [INPUT_WIDTH+3:0] n_s3_plus1;
wire [INPUT_WIDTH+3:0] n_t2_plus1;
wire [INPUT_WIDTH+3:0] n_t3_plus1;

wire [INPUT_WIDTH+3:0] r0, r1, r2, r3;
...
assign t3 = {s1_w[INPUT_WIDTH+3],s1_w[INPUT_WIDTH+3:1]} + n_s3_plus1;
